...
public class Image implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("[Pull policy](https://kubernetes.io/docs/concepts/containers/images/#image-pull-policy) used when pulling the Images")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    private java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.image.PullSecrets> pullSecrets;

    public java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.image.PullSecrets> getPullSecrets() {
        return pullSecrets;
    }

    public void setPullSecrets(java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.image.PullSecrets> pullSecrets) {
