...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.servers.podoverrides.spec.containers.resources.Claims> claims;

    public java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.servers.podoverrides.spec.containers.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.servers.podoverrides.spec.containers.resources.Claims> claims) {
        this.claims = claims;
    }
