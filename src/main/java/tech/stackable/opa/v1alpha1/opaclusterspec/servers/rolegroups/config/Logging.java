...
public class Logging implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.Map<java.lang.String, tech.stackable.opa.v1alpha1.opaclusterspec.servers.rolegroups.config.logging.Containers> containers;

    public java.util.Map<java.lang.String, tech.stackable.opa.v1alpha1.opaclusterspec.servers.rolegroups.config.logging.Containers> getContainers() {
        return containers;
    }

    public void setContainers(java.util.Map<java.lang.String, tech.stackable.opa.v1alpha1.opaclusterspec.servers.rolegroups.config.logging.Containers> containers) {
