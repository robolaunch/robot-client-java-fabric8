...
public class Metadata implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.servers.rolegroups.podoverrides.metadata.ManagedFields> managedFields;

    public java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.servers.rolegroups.podoverrides.metadata.ManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.servers.rolegroups.podoverrides.metadata.ManagedFields> managedFields) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.servers.rolegroups.podoverrides.metadata.OwnerReferences> ownerReferences;

    public java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.servers.rolegroups.podoverrides.metadata.OwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(java.util.List<tech.stackable.opa.v1alpha1.opaclusterspec.servers.rolegroups.podoverrides.metadata.OwnerReferences> ownerReferences) {
