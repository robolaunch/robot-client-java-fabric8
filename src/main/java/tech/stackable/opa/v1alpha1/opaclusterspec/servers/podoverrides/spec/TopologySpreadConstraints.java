...
public class TopologySpreadConstraints implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.opa.v1alpha1.opaclusterspec.servers.podoverrides.spec.topologyspreadconstraints.LabelSelector labelSelector;

    public tech.stackable.opa.v1alpha1.opaclusterspec.servers.podoverrides.spec.topologyspreadconstraints.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(tech.stackable.opa.v1alpha1.opaclusterspec.servers.podoverrides.spec.topologyspreadconstraints.LabelSelector labelSelector) {
