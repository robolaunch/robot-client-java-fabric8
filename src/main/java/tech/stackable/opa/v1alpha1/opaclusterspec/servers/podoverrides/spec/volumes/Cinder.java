...
public class Cinder implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.opa.v1alpha1.opaclusterspec.servers.podoverrides.spec.volumes.cinder.SecretRef secretRef;

    public tech.stackable.opa.v1alpha1.opaclusterspec.servers.podoverrides.spec.volumes.cinder.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(tech.stackable.opa.v1alpha1.opaclusterspec.servers.podoverrides.spec.volumes.cinder.SecretRef secretRef) {
