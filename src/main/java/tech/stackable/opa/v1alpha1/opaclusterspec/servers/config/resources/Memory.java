package tech.stackable.opa.v1alpha1.opaclusterspec.servers.config.resources;
...
public class Memory implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.opa.v1alpha1.opaclusterspec.servers.config.resources.memory.RuntimeLimits runtimeLimits;

    public tech.stackable.opa.v1alpha1.opaclusterspec.servers.config.resources.memory.RuntimeLimits getRuntimeLimits() {
        return runtimeLimits;
    }

    public void setRuntimeLimits(tech.stackable.opa.v1alpha1.opaclusterspec.servers.config.resources.memory.RuntimeLimits runtimeLimits) {
