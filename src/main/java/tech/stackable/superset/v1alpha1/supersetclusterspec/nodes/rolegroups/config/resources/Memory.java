...
public class Memory implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.rolegroups.config.resources.memory.RuntimeLimits runtimeLimits;

    public tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.rolegroups.config.resources.memory.RuntimeLimits getRuntimeLimits() {
        return runtimeLimits;
    }

    public void setRuntimeLimits(tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.rolegroups.config.resources.memory.RuntimeLimits runtimeLimits) {
