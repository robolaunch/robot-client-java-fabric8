...
public class RoleConfig implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.roleconfig.PodDisruptionBudget podDisruptionBudget = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"enabled\":true,\"maxUnavailable\":null}", tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.roleconfig.PodDisruptionBudget.class);

    public tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.roleconfig.PodDisruptionBudget getPodDisruptionBudget() {
        return podDisruptionBudget;
    }

    public void setPodDisruptionBudget(tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.roleconfig.PodDisruptionBudget podDisruptionBudget) {
