...
public class TopologySpreadConstraints implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.podoverrides.spec.topologyspreadconstraints.LabelSelector labelSelector;

    public tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.podoverrides.spec.topologyspreadconstraints.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.podoverrides.spec.topologyspreadconstraints.LabelSelector labelSelector) {
