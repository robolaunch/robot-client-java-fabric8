...
public class FlexVolume implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.podoverrides.spec.volumes.flexvolume.SecretRef secretRef;

    public tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.podoverrides.spec.volumes.flexvolume.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.podoverrides.spec.volumes.flexvolume.SecretRef secretRef) {
