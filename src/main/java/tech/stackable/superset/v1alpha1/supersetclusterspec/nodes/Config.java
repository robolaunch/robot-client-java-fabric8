package tech.stackable.superset.v1alpha1.supersetclusterspec.nodes;
...
public class Config implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Affinity affinity = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"podAffinity\":null,\"podAntiAffinity\":null,\"nodeAffinity\":null,\"nodeSelector\":null}", tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Affinity.class);

    public tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Logging logging = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"enableVectorAgent\":null,\"containers\":{}}", tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Logging.class);

    public tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Logging getLogging() {
        return logging;
    }

    public void setLogging(tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Logging logging) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Resources resources = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"memory\":{\"limit\":null,\"runtimeLimits\":{}},\"cpu\":{\"min\":null,\"max\":null},\"storage\":{}}", tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Resources.class);

    public tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Resources getResources() {
        return resources;
    }

    public void setResources(tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.Resources resources) {
