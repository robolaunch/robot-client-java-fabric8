...
public class Logging implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.Map<java.lang.String, tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.logging.Containers> containers;

    public java.util.Map<java.lang.String, tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.logging.Containers> getContainers() {
        return containers;
    }

    public void setContainers(java.util.Map<java.lang.String, tech.stackable.superset.v1alpha1.supersetclusterspec.nodes.config.logging.Containers> containers) {
