...
public class Iscsi implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.podoverrides.spec.volumes.iscsi.SecretRef secretRef;

    public tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.podoverrides.spec.volumes.iscsi.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.podoverrides.spec.volumes.iscsi.SecretRef secretRef) {
