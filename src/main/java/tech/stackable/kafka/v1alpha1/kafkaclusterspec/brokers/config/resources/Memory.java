...
public class Memory implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.resources.memory.RuntimeLimits runtimeLimits;

    public tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.resources.memory.RuntimeLimits getRuntimeLimits() {
        return runtimeLimits;
    }

    public void setRuntimeLimits(tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.resources.memory.RuntimeLimits runtimeLimits) {
