package tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.resources.storage.logdirs;
...
public class Selectors implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.resources.storage.logdirs.selectors.MatchExpressions> matchExpressions;

    public java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.resources.storage.logdirs.selectors.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.resources.storage.logdirs.selectors.MatchExpressions> matchExpressions) {
