...
public class Config implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Affinity affinity = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"podAffinity\":null,\"podAntiAffinity\":null,\"nodeAffinity\":null,\"nodeSelector\":null}", tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Affinity.class);

    public tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Logging logging = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"enableVectorAgent\":null,\"containers\":{}}", tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Logging.class);

    public tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Logging getLogging() {
        return logging;
    }

    public void setLogging(tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Logging logging) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Resources resources = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"memory\":{\"limit\":null,\"runtimeLimits\":{}},\"cpu\":{\"min\":null,\"max\":null},\"storage\":{\"logDirs\":{\"capacity\":null}}}", tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Resources.class);

    public tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Resources getResources() {
        return resources;
    }

    public void setResources(tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.Resources resources) {
