...
public class RoleConfig implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.roleconfig.PodDisruptionBudget podDisruptionBudget = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"enabled\":true,\"maxUnavailable\":null}", tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.roleconfig.PodDisruptionBudget.class);

    public tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.roleconfig.PodDisruptionBudget getPodDisruptionBudget() {
        return podDisruptionBudget;
    }

    public void setPodDisruptionBudget(tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.roleconfig.PodDisruptionBudget podDisruptionBudget) {
