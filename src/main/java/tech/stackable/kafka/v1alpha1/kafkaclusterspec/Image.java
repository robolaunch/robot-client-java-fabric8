...
public class Image implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.image.PullSecrets> pullSecrets;

    public java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.image.PullSecrets> getPullSecrets() {
        return pullSecrets;
    }

    public void setPullSecrets(java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.image.PullSecrets> pullSecrets) {
