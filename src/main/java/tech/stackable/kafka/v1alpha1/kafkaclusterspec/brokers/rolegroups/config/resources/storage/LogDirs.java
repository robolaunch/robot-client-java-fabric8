package tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.resources.storage;
...
public class LogDirs implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.resources.storage.logdirs.Selectors selectors;

    public tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.resources.storage.logdirs.Selectors getSelectors() {
        return selectors;
    }

    public void setSelectors(tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.resources.storage.logdirs.Selectors selectors) {
