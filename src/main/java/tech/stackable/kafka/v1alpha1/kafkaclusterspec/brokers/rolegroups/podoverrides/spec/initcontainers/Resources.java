...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.podoverrides.spec.initcontainers.resources.Claims> claims;

    public java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.podoverrides.spec.initcontainers.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.podoverrides.spec.initcontainers.resources.Claims> claims) {
        this.claims = claims;
    }
