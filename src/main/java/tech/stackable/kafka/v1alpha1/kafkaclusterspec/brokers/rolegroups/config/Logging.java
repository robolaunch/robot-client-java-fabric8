...
public class Logging implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.Map<java.lang.String, tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.logging.Containers> containers;

    public java.util.Map<java.lang.String, tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.logging.Containers> getContainers() {
        return containers;
    }

    public void setContainers(java.util.Map<java.lang.String, tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.rolegroups.config.logging.Containers> containers) {
