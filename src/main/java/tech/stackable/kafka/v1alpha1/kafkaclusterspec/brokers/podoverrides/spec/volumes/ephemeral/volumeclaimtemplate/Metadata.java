...
public class Metadata implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.spec.volumes.ephemeral.volumeclaimtemplate.metadata.ManagedFields> managedFields;

    public java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.spec.volumes.ephemeral.volumeclaimtemplate.metadata.ManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.spec.volumes.ephemeral.volumeclaimtemplate.metadata.ManagedFields> managedFields) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.spec.volumes.ephemeral.volumeclaimtemplate.metadata.OwnerReferences> ownerReferences;

    public java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.spec.volumes.ephemeral.volumeclaimtemplate.metadata.OwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.spec.volumes.ephemeral.volumeclaimtemplate.metadata.OwnerReferences> ownerReferences) {
