package tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.metadata;
...
public class ManagedFields implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.metadata.managedfields.FieldsV1 fieldsV1;

    public tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.metadata.managedfields.FieldsV1 getFieldsV1() {
        return fieldsV1;
    }

    public void setFieldsV1(tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.metadata.managedfields.FieldsV1 fieldsV1) {
