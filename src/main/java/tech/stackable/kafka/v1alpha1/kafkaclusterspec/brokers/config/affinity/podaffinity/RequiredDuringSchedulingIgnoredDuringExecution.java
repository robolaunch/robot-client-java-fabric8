package tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.affinity.podaffinity;
...
public class RequiredDuringSchedulingIgnoredDuringExecution implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.affinity.podaffinity.requiredduringschedulingignoredduringexecution.LabelSelector labelSelector;

    public tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.affinity.podaffinity.requiredduringschedulingignoredduringexecution.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.affinity.podaffinity.requiredduringschedulingignoredduringexecution.LabelSelector labelSelector) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.affinity.podaffinity.requiredduringschedulingignoredduringexecution.NamespaceSelector namespaceSelector;

    public tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.affinity.podaffinity.requiredduringschedulingignoredduringexecution.NamespaceSelector getNamespaceSelector() {
        return namespaceSelector;
    }

    public void setNamespaceSelector(tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.config.affinity.podaffinity.requiredduringschedulingignoredduringexecution.NamespaceSelector namespaceSelector) {
