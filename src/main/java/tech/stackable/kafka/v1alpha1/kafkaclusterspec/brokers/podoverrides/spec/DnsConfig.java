...
public class DnsConfig implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.spec.dnsconfig.Options> options;

    public java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.spec.dnsconfig.Options> getOptions() {
        return options;
    }

    public void setOptions(java.util.List<tech.stackable.kafka.v1alpha1.kafkaclusterspec.brokers.podoverrides.spec.dnsconfig.Options> options) {
