...
public class Credentials implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.s3.v1alpha1.s3connectionspec.credentials.Scope scope;

    public tech.stackable.s3.v1alpha1.s3connectionspec.credentials.Scope getScope() {
        return scope;
    }

    public void setScope(tech.stackable.s3.v1alpha1.s3connectionspec.credentials.Scope scope) {
        this.scope = scope;
    }
