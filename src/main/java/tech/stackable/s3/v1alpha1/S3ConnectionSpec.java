...
public class S3ConnectionSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private tech.stackable.s3.v1alpha1.s3connectionspec.Credentials credentials;

    public tech.stackable.s3.v1alpha1.s3connectionspec.Credentials getCredentials() {
        return credentials;
    }

    public void setCredentials(tech.stackable.s3.v1alpha1.s3connectionspec.Credentials credentials) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private tech.stackable.s3.v1alpha1.s3connectionspec.Tls tls;

    public tech.stackable.s3.v1alpha1.s3connectionspec.Tls getTls() {
        return tls;
    }

    public void setTls(tech.stackable.s3.v1alpha1.s3connectionspec.Tls tls) {
        this.tls = tls;
    }
}
