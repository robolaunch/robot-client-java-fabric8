...
public class Tls implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.s3.v1alpha1.s3bucketspec.connection.inline.tls.Verification verification;

    public tech.stackable.s3.v1alpha1.s3bucketspec.connection.inline.tls.Verification getVerification() {
        return verification;
    }

    public void setVerification(tech.stackable.s3.v1alpha1.s3bucketspec.connection.inline.tls.Verification verification) {
