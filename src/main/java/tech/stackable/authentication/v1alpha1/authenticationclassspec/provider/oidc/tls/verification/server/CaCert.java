package tech.stackable.authentication.v1alpha1.authenticationclassspec.provider.oidc.tls.verification.server;
...
public class CaCert implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.authentication.v1alpha1.authenticationclassspec.provider.oidc.tls.verification.server.cacert.WebPki webPki;

    public tech.stackable.authentication.v1alpha1.authenticationclassspec.provider.oidc.tls.verification.server.cacert.WebPki getWebPki() {
        return webPki;
    }

    public void setWebPki(tech.stackable.authentication.v1alpha1.authenticationclassspec.provider.oidc.tls.verification.server.cacert.WebPki webPki) {
        this.webPki = webPki;
    }
}
