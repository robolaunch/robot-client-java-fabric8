...
public class TopologySpreadConstraints implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.spec.topologyspreadconstraints.LabelSelector labelSelector;

    public tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.spec.topologyspreadconstraints.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.spec.topologyspreadconstraints.LabelSelector labelSelector) {
