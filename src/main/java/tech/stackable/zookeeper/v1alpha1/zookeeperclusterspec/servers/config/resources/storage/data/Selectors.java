...
public class Selectors implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.config.resources.storage.data.selectors.MatchExpressions> matchExpressions;

    public java.util.List<tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.config.resources.storage.data.selectors.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.config.resources.storage.data.selectors.MatchExpressions> matchExpressions) {
