...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.spec.ephemeralcontainers.resources.Claims> claims;

    public java.util.List<tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.spec.ephemeralcontainers.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(java.util.List<tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.spec.ephemeralcontainers.resources.Claims> claims) {
        this.claims = claims;
    }
