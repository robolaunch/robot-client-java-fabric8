...
public class Memory implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.rolegroups.config.resources.memory.RuntimeLimits runtimeLimits;

    public tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.rolegroups.config.resources.memory.RuntimeLimits getRuntimeLimits() {
        return runtimeLimits;
    }

    public void setRuntimeLimits(tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.rolegroups.config.resources.memory.RuntimeLimits runtimeLimits) {
