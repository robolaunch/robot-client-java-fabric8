...
public class Containers implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.config.logging.containers.Loggers> loggers = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{}", java.util.Map.class);

    public java.util.Map<java.lang.String, tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.config.logging.containers.Loggers> getLoggers() {
        return loggers;
    }

    public void setLoggers(java.util.Map<java.lang.String, tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.config.logging.containers.Loggers> loggers) {
