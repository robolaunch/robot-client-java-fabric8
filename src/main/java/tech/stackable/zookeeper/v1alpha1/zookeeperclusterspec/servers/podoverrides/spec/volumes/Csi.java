...
public class Csi implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.spec.volumes.csi.NodePublishSecretRef nodePublishSecretRef;

    public tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.spec.volumes.csi.NodePublishSecretRef getNodePublishSecretRef() {
        return nodePublishSecretRef;
    }

    public void setNodePublishSecretRef(tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.spec.volumes.csi.NodePublishSecretRef nodePublishSecretRef) {
