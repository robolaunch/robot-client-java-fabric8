package tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.metadata;
...
public class ManagedFields implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.metadata.managedfields.FieldsV1 fieldsV1;

    public tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.metadata.managedfields.FieldsV1 getFieldsV1() {
        return fieldsV1;
    }

    public void setFieldsV1(tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.podoverrides.metadata.managedfields.FieldsV1 fieldsV1) {
