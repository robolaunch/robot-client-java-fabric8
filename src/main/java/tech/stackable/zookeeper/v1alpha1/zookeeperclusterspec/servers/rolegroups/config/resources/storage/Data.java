package tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.rolegroups.config.resources.storage;
...
public class Data implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.rolegroups.config.resources.storage.data.Selectors selectors;

    public tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.rolegroups.config.resources.storage.data.Selectors getSelectors() {
        return selectors;
    }

    public void setSelectors(tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.rolegroups.config.resources.storage.data.Selectors selectors) {
