...
public class Servers implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.RoleGroups> roleGroups;

    public java.util.Map<java.lang.String, tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.RoleGroups> getRoleGroups() {
        return roleGroups;
    }

    public void setRoleGroups(java.util.Map<java.lang.String, tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.servers.RoleGroups> roleGroups) {
