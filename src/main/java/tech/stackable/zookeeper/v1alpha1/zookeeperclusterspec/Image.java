...
public class Image implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.image.PullSecrets> pullSecrets;

    public java.util.List<tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.image.PullSecrets> getPullSecrets() {
        return pullSecrets;
    }

    public void setPullSecrets(java.util.List<tech.stackable.zookeeper.v1alpha1.zookeeperclusterspec.image.PullSecrets> pullSecrets) {
