...
public class Config implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Affinity affinity = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"podAffinity\":null,\"podAntiAffinity\":null,\"nodeAffinity\":null,\"nodeSelector\":null}", tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Affinity.class);

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Logging logging = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"enableVectorAgent\":null,\"containers\":{}}", tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Logging.class);

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Logging getLogging() {
        return logging;
    }

    public void setLogging(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Logging logging) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Resources resources = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"memory\":{\"limit\":null,\"runtimeLimits\":{}},\"cpu\":{\"min\":null,\"max\":null},\"storage\":{\"flowfileRepo\":{\"capacity\":null},\"provenanceRepo\":{\"capacity\":null},\"databaseRepo\":{\"capacity\":null},\"contentRepo\":{\"capacity\":null},\"stateRepo\":{\"capacity\":null}}}", tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Resources.class);

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Resources getResources() {
        return resources;
    }

    public void setResources(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.Resources resources) {
