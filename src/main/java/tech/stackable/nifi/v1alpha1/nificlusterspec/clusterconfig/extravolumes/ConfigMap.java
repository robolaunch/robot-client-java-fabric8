...
public class ConfigMap implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.configmap.Items> items;

    public java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.configmap.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.configmap.Items> items) {
        this.items = items;
    }
