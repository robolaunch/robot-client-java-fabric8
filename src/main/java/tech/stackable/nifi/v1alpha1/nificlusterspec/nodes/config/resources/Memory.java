...
public class Memory implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.resources.memory.RuntimeLimits runtimeLimits;

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.resources.memory.RuntimeLimits getRuntimeLimits() {
        return runtimeLimits;
    }

    public void setRuntimeLimits(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.resources.memory.RuntimeLimits runtimeLimits) {
