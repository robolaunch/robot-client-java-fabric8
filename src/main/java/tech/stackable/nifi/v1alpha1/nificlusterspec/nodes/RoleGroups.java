...
public class RoleGroups implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.Config config = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{}", tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.Config.class);

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.Config getConfig() {
        return config;
    }

    public void setConfig(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.Config config) {
        this.config = config;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.PodOverrides podOverrides = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{}", tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.PodOverrides.class);

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.PodOverrides getPodOverrides() {
        return podOverrides;
    }

    public void setPodOverrides(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.PodOverrides podOverrides) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.Selector selector;

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.Selector getSelector() {
        return selector;
    }

    public void setSelector(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.Selector selector) {
