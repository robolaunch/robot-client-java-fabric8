...
public class Secret implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.projected.sources.secret.Items> items;

    public java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.projected.sources.secret.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.projected.sources.secret.Items> items) {
        this.items = items;
    }
