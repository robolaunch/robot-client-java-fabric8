package tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.resources.storage.flowfilerepo;
...
public class Selectors implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.resources.storage.flowfilerepo.selectors.MatchExpressions> matchExpressions;

    public java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.resources.storage.flowfilerepo.selectors.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.resources.storage.flowfilerepo.selectors.MatchExpressions> matchExpressions) {
