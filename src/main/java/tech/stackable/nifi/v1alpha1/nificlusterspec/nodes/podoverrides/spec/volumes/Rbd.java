...
public class Rbd implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.podoverrides.spec.volumes.rbd.SecretRef secretRef;

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.podoverrides.spec.volumes.rbd.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.podoverrides.spec.volumes.rbd.SecretRef secretRef) {
