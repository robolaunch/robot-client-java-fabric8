package tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.config.resources.storage.contentrepo;
...
public class Selectors implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.config.resources.storage.contentrepo.selectors.MatchExpressions> matchExpressions;

    public java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.config.resources.storage.contentrepo.selectors.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.rolegroups.config.resources.storage.contentrepo.selectors.MatchExpressions> matchExpressions) {
