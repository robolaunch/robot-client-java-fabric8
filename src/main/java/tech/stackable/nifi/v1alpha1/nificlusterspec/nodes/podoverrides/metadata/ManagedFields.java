...
public class ManagedFields implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.podoverrides.metadata.managedfields.FieldsV1 fieldsV1;

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.podoverrides.metadata.managedfields.FieldsV1 getFieldsV1() {
        return fieldsV1;
    }

    public void setFieldsV1(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.podoverrides.metadata.managedfields.FieldsV1 fieldsV1) {
