...
public class StateRepo implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SET)
    @io.fabric8.generator.annotation.Nullable()
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.resources.storage.staterepo.Selectors selectors;

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.resources.storage.staterepo.Selectors getSelectors() {
        return selectors;
    }

    public void setSelectors(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.config.resources.storage.staterepo.Selectors selectors) {
