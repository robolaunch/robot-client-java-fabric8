...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.ephemeral.volumeclaimtemplate.spec.selector.MatchExpressions> matchExpressions;

    public java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.ephemeral.volumeclaimtemplate.spec.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.ephemeral.volumeclaimtemplate.spec.selector.MatchExpressions> matchExpressions) {
