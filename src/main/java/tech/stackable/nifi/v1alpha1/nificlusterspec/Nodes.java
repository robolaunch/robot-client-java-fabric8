...
public class Nodes implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.Config config = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{}", tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.Config.class);

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.Config getConfig() {
        return config;
    }

    public void setConfig(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.Config config) {
        this.config = config;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.PodOverrides podOverrides = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{}", tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.PodOverrides.class);

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.PodOverrides getPodOverrides() {
        return podOverrides;
    }

    public void setPodOverrides(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.PodOverrides podOverrides) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.RoleConfig roleConfig = io.fabric8.kubernetes.client.utils.Serialization.unmarshal("{\"podDisruptionBudget\":{\"enabled\":true,\"maxUnavailable\":null}}", tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.RoleConfig.class);

    public tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.RoleConfig getRoleConfig() {
        return roleConfig;
    }

    public void setRoleConfig(tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.RoleConfig roleConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.RoleGroups> roleGroups;

    public java.util.Map<java.lang.String, tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.RoleGroups> getRoleGroups() {
        return roleGroups;
    }

    public void setRoleGroups(java.util.Map<java.lang.String, tech.stackable.nifi.v1alpha1.nificlusterspec.nodes.RoleGroups> roleGroups) {
