...
public class Csi implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.csi.NodePublishSecretRef nodePublishSecretRef;

    public tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.csi.NodePublishSecretRef getNodePublishSecretRef() {
        return nodePublishSecretRef;
    }

    public void setNodePublishSecretRef(tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.csi.NodePublishSecretRef nodePublishSecretRef) {
