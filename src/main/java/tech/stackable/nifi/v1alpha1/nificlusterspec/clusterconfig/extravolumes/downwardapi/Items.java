package tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.downwardapi;
...
public class Items implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.downwardapi.items.FieldRef fieldRef;

    public tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.downwardapi.items.FieldRef getFieldRef() {
        return fieldRef;
    }

    public void setFieldRef(tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.downwardapi.items.FieldRef fieldRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.downwardapi.items.ResourceFieldRef resourceFieldRef;

    public tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.downwardapi.items.ResourceFieldRef getResourceFieldRef() {
        return resourceFieldRef;
    }

    public void setResourceFieldRef(tech.stackable.nifi.v1alpha1.nificlusterspec.clusterconfig.extravolumes.downwardapi.items.ResourceFieldRef resourceFieldRef) {
