...
public class Image implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.image.PullSecrets> pullSecrets;

    public java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.image.PullSecrets> getPullSecrets() {
        return pullSecrets;
    }

    public void setPullSecrets(java.util.List<tech.stackable.nifi.v1alpha1.nificlusterspec.image.PullSecrets> pullSecrets) {
