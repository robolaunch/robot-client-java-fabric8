...
public class Sync implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.Resources> resources;

    public java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.Resources> getResources() {
        return resources;
    }

    public void setResources(java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.Resources> resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.Source source;

    public io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.Source getSource() {
        return source;
    }

    public void setSource(io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.Source source) {
        this.source = source;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.Sources> sources;

    public java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.Sources> getSources() {
        return sources;
    }

    public void setSources(java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.Sources> sources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.SyncStrategy syncStrategy;

    public io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.SyncStrategy getSyncStrategy() {
        return syncStrategy;
    }

    public void setSyncStrategy(io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.SyncStrategy syncStrategy) {
