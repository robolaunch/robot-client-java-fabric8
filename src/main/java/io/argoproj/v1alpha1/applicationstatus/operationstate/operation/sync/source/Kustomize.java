...
public class Kustomize implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.kustomize.Patches> patches;

    public java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.kustomize.Patches> getPatches() {
        return patches;
    }

    public void setPatches(java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.kustomize.Patches> patches) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.kustomize.Replicas> replicas;

    public java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.kustomize.Replicas> getReplicas() {
        return replicas;
    }

    public void setReplicas(java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.kustomize.Replicas> replicas) {
