...
public class Sources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Directory directory;

    public io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Directory getDirectory() {
        return directory;
    }

    public void setDirectory(io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Directory directory) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Helm helm;

    public io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Helm getHelm() {
        return helm;
    }

    public void setHelm(io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Helm helm) {
        this.helm = helm;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Kustomize kustomize;

    public io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Kustomize getKustomize() {
        return kustomize;
    }

    public void setKustomize(io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Kustomize kustomize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Plugin plugin;

    public io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Plugin getPlugin() {
        return plugin;
    }

    public void setPlugin(io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Plugin plugin) {
        this.plugin = plugin;
    }
