...
public class Patches implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.source.kustomize.patches.Target target;

    public io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.source.kustomize.patches.Target getTarget() {
        return target;
    }

    public void setTarget(io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.source.kustomize.patches.Target target) {
        this.target = target;
    }
}
