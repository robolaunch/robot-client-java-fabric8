...
public class Directory implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.source.directory.Jsonnet jsonnet;

    public io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.source.directory.Jsonnet getJsonnet() {
        return jsonnet;
    }

    public void setJsonnet(io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.source.directory.Jsonnet jsonnet) {
