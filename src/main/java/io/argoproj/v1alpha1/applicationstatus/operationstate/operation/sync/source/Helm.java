...
public class Helm implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.helm.FileParameters> fileParameters;

    public java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.helm.FileParameters> getFileParameters() {
        return fileParameters;
    }

    public void setFileParameters(java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.helm.FileParameters> fileParameters) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.helm.Parameters> parameters;

    public java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.helm.Parameters> getParameters() {
        return parameters;
    }

    public void setParameters(java.util.List<io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.helm.Parameters> parameters) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.helm.ValuesObject valuesObject;

    public io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.helm.ValuesObject getValuesObject() {
        return valuesObject;
    }

    public void setValuesObject(io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.helm.ValuesObject valuesObject) {
