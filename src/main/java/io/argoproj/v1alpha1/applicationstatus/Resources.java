...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.resources.Health health;

    public io.argoproj.v1alpha1.applicationstatus.resources.Health getHealth() {
        return health;
    }

    public void setHealth(io.argoproj.v1alpha1.applicationstatus.resources.Health health) {
        this.health = health;
    }
