...
public class Sync implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.argoproj.v1alpha1.applicationstatus.sync.ComparedTo comparedTo;

    public io.argoproj.v1alpha1.applicationstatus.sync.ComparedTo getComparedTo() {
        return comparedTo;
    }

    public void setComparedTo(io.argoproj.v1alpha1.applicationstatus.sync.ComparedTo comparedTo) {
