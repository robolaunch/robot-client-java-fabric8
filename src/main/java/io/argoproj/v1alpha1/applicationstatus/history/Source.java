...
public class Source implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.history.source.Directory directory;

    public io.argoproj.v1alpha1.applicationstatus.history.source.Directory getDirectory() {
        return directory;
    }

    public void setDirectory(io.argoproj.v1alpha1.applicationstatus.history.source.Directory directory) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.history.source.Helm helm;

    public io.argoproj.v1alpha1.applicationstatus.history.source.Helm getHelm() {
        return helm;
    }

    public void setHelm(io.argoproj.v1alpha1.applicationstatus.history.source.Helm helm) {
        this.helm = helm;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.history.source.Kustomize kustomize;

    public io.argoproj.v1alpha1.applicationstatus.history.source.Kustomize getKustomize() {
        return kustomize;
    }

    public void setKustomize(io.argoproj.v1alpha1.applicationstatus.history.source.Kustomize kustomize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.history.source.Plugin plugin;

    public io.argoproj.v1alpha1.applicationstatus.history.source.Plugin getPlugin() {
        return plugin;
    }

    public void setPlugin(io.argoproj.v1alpha1.applicationstatus.history.source.Plugin plugin) {
        this.plugin = plugin;
    }
