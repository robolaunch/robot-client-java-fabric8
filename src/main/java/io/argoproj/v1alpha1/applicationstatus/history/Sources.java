package io.argoproj.v1alpha1.applicationstatus.history;
...
public class Sources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.history.sources.Directory directory;

    public io.argoproj.v1alpha1.applicationstatus.history.sources.Directory getDirectory() {
        return directory;
    }

    public void setDirectory(io.argoproj.v1alpha1.applicationstatus.history.sources.Directory directory) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.history.sources.Helm helm;

    public io.argoproj.v1alpha1.applicationstatus.history.sources.Helm getHelm() {
        return helm;
    }

    public void setHelm(io.argoproj.v1alpha1.applicationstatus.history.sources.Helm helm) {
        this.helm = helm;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.history.sources.Kustomize kustomize;

    public io.argoproj.v1alpha1.applicationstatus.history.sources.Kustomize getKustomize() {
        return kustomize;
    }

    public void setKustomize(io.argoproj.v1alpha1.applicationstatus.history.sources.Kustomize kustomize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationstatus.history.sources.Plugin plugin;

    public io.argoproj.v1alpha1.applicationstatus.history.sources.Plugin getPlugin() {
        return plugin;
    }

    public void setPlugin(io.argoproj.v1alpha1.applicationstatus.history.sources.Plugin plugin) {
        this.plugin = plugin;
    }
