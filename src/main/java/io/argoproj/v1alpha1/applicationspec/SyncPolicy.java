...
public class SyncPolicy implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.argoproj.v1alpha1.applicationspec.syncpolicy.Automated automated;

    public io.argoproj.v1alpha1.applicationspec.syncpolicy.Automated getAutomated() {
        return automated;
    }

    public void setAutomated(io.argoproj.v1alpha1.applicationspec.syncpolicy.Automated automated) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationspec.syncpolicy.ManagedNamespaceMetadata managedNamespaceMetadata;

    public io.argoproj.v1alpha1.applicationspec.syncpolicy.ManagedNamespaceMetadata getManagedNamespaceMetadata() {
        return managedNamespaceMetadata;
    }

    public void setManagedNamespaceMetadata(io.argoproj.v1alpha1.applicationspec.syncpolicy.ManagedNamespaceMetadata managedNamespaceMetadata) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationspec.syncpolicy.Retry retry;

    public io.argoproj.v1alpha1.applicationspec.syncpolicy.Retry getRetry() {
        return retry;
    }

    public void setRetry(io.argoproj.v1alpha1.applicationspec.syncpolicy.Retry retry) {
        this.retry = retry;
    }
