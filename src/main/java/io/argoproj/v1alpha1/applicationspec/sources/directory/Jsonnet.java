package io.argoproj.v1alpha1.applicationspec.sources.directory;
...
public class Jsonnet implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.argoproj.v1alpha1.applicationspec.sources.directory.jsonnet.ExtVars> extVars;

    public java.util.List<io.argoproj.v1alpha1.applicationspec.sources.directory.jsonnet.ExtVars> getExtVars() {
        return extVars;
    }

    public void setExtVars(java.util.List<io.argoproj.v1alpha1.applicationspec.sources.directory.jsonnet.ExtVars> extVars) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.argoproj.v1alpha1.applicationspec.sources.directory.jsonnet.Tlas> tlas;

    public java.util.List<io.argoproj.v1alpha1.applicationspec.sources.directory.jsonnet.Tlas> getTlas() {
        return tlas;
    }

    public void setTlas(java.util.List<io.argoproj.v1alpha1.applicationspec.sources.directory.jsonnet.Tlas> tlas) {
        this.tlas = tlas;
    }
}
