package io.argoproj.v1alpha1.applicationspec.sources.kustomize;
...
public class Patches implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationspec.sources.kustomize.patches.Target target;

    public io.argoproj.v1alpha1.applicationspec.sources.kustomize.patches.Target getTarget() {
        return target;
    }

    public void setTarget(io.argoproj.v1alpha1.applicationspec.sources.kustomize.patches.Target target) {
        this.target = target;
    }
}
