...
public class Retry implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.argoproj.v1alpha1.applicationspec.syncpolicy.retry.Backoff backoff;

    public io.argoproj.v1alpha1.applicationspec.syncpolicy.retry.Backoff getBackoff() {
        return backoff;
    }

    public void setBackoff(io.argoproj.v1alpha1.applicationspec.syncpolicy.retry.Backoff backoff) {
