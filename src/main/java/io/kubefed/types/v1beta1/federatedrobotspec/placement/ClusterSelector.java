package io.kubefed.types.v1beta1.federatedrobotspec.placement;
...
public class ClusterSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.kubefed.types.v1beta1.federatedrobotspec.placement.clusterselector.MatchExpressions> matchExpressions;

    public java.util.List<io.kubefed.types.v1beta1.federatedrobotspec.placement.clusterselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<io.kubefed.types.v1beta1.federatedrobotspec.placement.clusterselector.MatchExpressions> matchExpressions) {
