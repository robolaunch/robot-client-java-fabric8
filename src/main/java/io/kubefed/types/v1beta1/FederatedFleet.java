...
public class FederatedFleet extends io.fabric8.kubernetes.client.CustomResource<io.kubefed.types.v1beta1.FederatedFleetSpec, io.kubefed.types.v1beta1.FederatedFleetStatus> {
}
