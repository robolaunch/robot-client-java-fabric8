...
public class Placement implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.kubefed.types.v1beta1.federatedros2workloadspec.placement.Clusters> clusters;

    public java.util.List<io.kubefed.types.v1beta1.federatedros2workloadspec.placement.Clusters> getClusters() {
        return clusters;
    }

    public void setClusters(java.util.List<io.kubefed.types.v1beta1.federatedros2workloadspec.placement.Clusters> clusters) {
