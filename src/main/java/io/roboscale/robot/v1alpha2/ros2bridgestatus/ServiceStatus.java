...
public class ServiceStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.roboscale.robot.v1alpha2.ros2bridgestatus.servicestatus.Resource resource;

    public io.roboscale.robot.v1alpha2.ros2bridgestatus.servicestatus.Resource getResource() {
        return resource;
    }

    public void setResource(io.roboscale.robot.v1alpha2.ros2bridgestatus.servicestatus.Resource resource) {
