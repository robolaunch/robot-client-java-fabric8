...
public class ConfigMap implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.configmap.Items> items;

    public java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.configmap.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.configmap.Items> items) {
        this.items = items;
    }
