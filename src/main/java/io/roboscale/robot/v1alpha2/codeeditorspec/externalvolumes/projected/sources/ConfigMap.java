...
public class ConfigMap implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.projected.sources.configmap.Items> items;

    public java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.projected.sources.configmap.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.projected.sources.configmap.Items> items) {
        this.items = items;
    }
