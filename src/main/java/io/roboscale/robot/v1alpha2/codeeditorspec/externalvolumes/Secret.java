...
public class Secret implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("defaultMode is Optional: mode bits used to set permissions on created files by default.\nMust be an octal value between 0000 and 0777 or a decimal value between 0 and 511.\nYAML accepts both octal and decimal values, JSON requires decimal values\nfor mode bits. Defaults to 0644.\nDirectories within the path are not affected by this setting.\nThis might be in conflict with other options that affect the file\nmode, like fsGroup, and the result can be other mode bits set.")
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.secret.Items> items;

    public java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.secret.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.secret.Items> items) {
        this.items = items;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("secretName is the name of the secret in the pod's namespace to use.\nMore info: https://kubernetes.io/docs/concepts/storage/volumes#secret")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
