...
public class FlexVolume implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    public io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.flexvolume.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.flexvolume.SecretRef secretRef) {
