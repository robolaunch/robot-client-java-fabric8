...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.ephemeral.volumeclaimtemplate.spec.selector.MatchExpressions> matchExpressions;

    public java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.ephemeral.volumeclaimtemplate.spec.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.ephemeral.volumeclaimtemplate.spec.selector.MatchExpressions> matchExpressions) {
