...
public class Csi implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    public io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.csi.NodePublishSecretRef getNodePublishSecretRef() {
        return nodePublishSecretRef;
    }

    public void setNodePublishSecretRef(io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.csi.NodePublishSecretRef nodePublishSecretRef) {
