...
public class Iscsi implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.iscsi.SecretRef secretRef;

    public io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.iscsi.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.iscsi.SecretRef secretRef) {
