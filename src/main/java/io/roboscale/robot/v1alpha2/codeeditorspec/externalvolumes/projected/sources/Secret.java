...
public class Secret implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    public java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.projected.sources.secret.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<io.roboscale.robot.v1alpha2.codeeditorspec.externalvolumes.projected.sources.secret.Items> items) {
        this.items = items;
    }
