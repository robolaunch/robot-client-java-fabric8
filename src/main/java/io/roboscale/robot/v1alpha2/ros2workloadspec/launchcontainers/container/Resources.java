...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    public java.util.List<io.roboscale.robot.v1alpha2.ros2workloadspec.launchcontainers.container.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(java.util.List<io.roboscale.robot.v1alpha2.ros2workloadspec.launchcontainers.container.resources.Claims> claims) {
        this.claims = claims;
    }
