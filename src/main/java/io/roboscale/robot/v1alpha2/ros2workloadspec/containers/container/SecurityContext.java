...
public class SecurityContext implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.Capabilities capabilities;

    public io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.Capabilities getCapabilities() {
        return capabilities;
    }

    public void setCapabilities(io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.Capabilities capabilities) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.SeLinuxOptions seLinuxOptions;

    public io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.SeccompProfile seccompProfile;

    public io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.WindowsOptions windowsOptions;

    public io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.securitycontext.WindowsOptions windowsOptions) {
