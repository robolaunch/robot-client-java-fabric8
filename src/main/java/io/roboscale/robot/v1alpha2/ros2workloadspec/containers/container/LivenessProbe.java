...
public class LivenessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.Exec exec;

    public io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.Grpc grpc;

    public io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.HttpGet httpGet;

    public io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.TcpSocket tcpSocket;

    public io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.livenessprobe.TcpSocket tcpSocket) {
