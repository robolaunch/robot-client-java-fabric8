...
public class Env implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.ros2workloadspec.launchcontainers.container.env.ValueFrom valueFrom;

    public io.roboscale.robot.v1alpha2.ros2workloadspec.launchcontainers.container.env.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(io.roboscale.robot.v1alpha2.ros2workloadspec.launchcontainers.container.env.ValueFrom valueFrom) {
