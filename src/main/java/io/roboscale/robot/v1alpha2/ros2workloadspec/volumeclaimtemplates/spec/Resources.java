...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.roboscale.robot.v1alpha2.ros2workloadspec.volumeclaimtemplates.spec.resources.Claims> claims;

    public java.util.List<io.roboscale.robot.v1alpha2.ros2workloadspec.volumeclaimtemplates.spec.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(java.util.List<io.roboscale.robot.v1alpha2.ros2workloadspec.volumeclaimtemplates.spec.resources.Claims> claims) {
        this.claims = claims;
    }
