package io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.lifecycle.poststart;
...
public class HttpGet implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.lifecycle.poststart.httpget.HttpHeaders> httpHeaders;

    public java.util.List<io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.lifecycle.poststart.httpget.HttpHeaders> getHttpHeaders() {
        return httpHeaders;
    }

    public void setHttpHeaders(java.util.List<io.roboscale.robot.v1alpha2.ros2workloadspec.containers.container.lifecycle.poststart.httpget.HttpHeaders> httpHeaders) {
