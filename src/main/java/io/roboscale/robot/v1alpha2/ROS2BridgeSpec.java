...
public class ROS2BridgeSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.roboscale.robot.v1alpha2.ros2bridgespec.DiscoveryServerRef discoveryServerRef;

    public io.roboscale.robot.v1alpha2.ros2bridgespec.DiscoveryServerRef getDiscoveryServerRef() {
        return discoveryServerRef;
    }

    public void setDiscoveryServerRef(io.roboscale.robot.v1alpha2.ros2bridgespec.DiscoveryServerRef discoveryServerRef) {
