...
public class ContainerStatuses implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.codeeditorstatus.deploymentstatus.containerstatuses.LastState lastState;

    public io.roboscale.robot.v1alpha2.codeeditorstatus.deploymentstatus.containerstatuses.LastState getLastState() {
        return lastState;
    }

    public void setLastState(io.roboscale.robot.v1alpha2.codeeditorstatus.deploymentstatus.containerstatuses.LastState lastState) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha2.codeeditorstatus.deploymentstatus.containerstatuses.State state;

    public io.roboscale.robot.v1alpha2.codeeditorstatus.deploymentstatus.containerstatuses.State getState() {
        return state;
    }

    public void setState(io.roboscale.robot.v1alpha2.codeeditorstatus.deploymentstatus.containerstatuses.State state) {
        this.state = state;
    }
}
