...
public class Status implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.robotstatus.robotdevsuitestatus.status.NotebookStatus notebookStatus;

    public io.roboscale.robot.v1alpha1.robotstatus.robotdevsuitestatus.status.NotebookStatus getNotebookStatus() {
        return notebookStatus;
    }

    public void setNotebookStatus(io.roboscale.robot.v1alpha1.robotstatus.robotdevsuitestatus.status.NotebookStatus notebookStatus) {
