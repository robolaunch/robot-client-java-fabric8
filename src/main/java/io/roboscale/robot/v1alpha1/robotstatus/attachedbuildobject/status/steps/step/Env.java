package io.roboscale.robot.v1alpha1.robotstatus.attachedbuildobject.status.steps.step;
...
public class Env implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.robotstatus.attachedbuildobject.status.steps.step.env.ValueFrom valueFrom;

    public io.roboscale.robot.v1alpha1.robotstatus.attachedbuildobject.status.steps.step.env.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(io.roboscale.robot.v1alpha1.robotstatus.attachedbuildobject.status.steps.step.env.ValueFrom valueFrom) {
