package io.roboscale.robot.v1alpha1.robotstatus.attachedlaunchobjects.status.launchpodstatus.launchstatus;
...
public class ContainerStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.robotstatus.attachedlaunchobjects.status.launchpodstatus.launchstatus.containerstatus.LastState lastState;

    public io.roboscale.robot.v1alpha1.robotstatus.attachedlaunchobjects.status.launchpodstatus.launchstatus.containerstatus.LastState getLastState() {
        return lastState;
    }

    public void setLastState(io.roboscale.robot.v1alpha1.robotstatus.attachedlaunchobjects.status.launchpodstatus.launchstatus.containerstatus.LastState lastState) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.robotstatus.attachedlaunchobjects.status.launchpodstatus.launchstatus.containerstatus.State state;

    public io.roboscale.robot.v1alpha1.robotstatus.attachedlaunchobjects.status.launchpodstatus.launchstatus.containerstatus.State getState() {
        return state;
    }

    public void setState(io.roboscale.robot.v1alpha1.robotstatus.attachedlaunchobjects.status.launchpodstatus.launchstatus.containerstatus.State state) {
        this.state = state;
    }
}
