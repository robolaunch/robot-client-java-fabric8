...
public class Status implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    public io.roboscale.robot.v1alpha1.robotstatus.attachedlaunchobjects.status.launchpodstatus.status.Resource getResource() {
        return resource;
    }

    public void setResource(io.roboscale.robot.v1alpha1.robotstatus.attachedlaunchobjects.status.launchpodstatus.status.Resource resource) {
