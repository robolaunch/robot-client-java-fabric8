...
public class Gpu implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    /**
     * MetricsExporter watches volatile GPU usage in the host machine if it's set to `true`.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("track")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("MetricsExporter watches volatile GPU usage in the host machine if it's set to `true`.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
