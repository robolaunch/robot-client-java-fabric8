package io.roboscale.robot.v1alpha1.workspacemanagerstatus;
...
public class CleanupJobStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.workspacemanagerstatus.cleanupjobstatus.Reference reference;

    public io.roboscale.robot.v1alpha1.workspacemanagerstatus.cleanupjobstatus.Reference getReference() {
        return reference;
    }

    public void setReference(io.roboscale.robot.v1alpha1.workspacemanagerstatus.cleanupjobstatus.Reference reference) {
