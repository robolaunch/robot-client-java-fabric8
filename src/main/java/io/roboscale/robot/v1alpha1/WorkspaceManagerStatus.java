...
public class WorkspaceManagerStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    public io.roboscale.robot.v1alpha1.workspacemanagerstatus.CleanupJobStatus getCleanupJobStatus() {
        return cleanupJobStatus;
    }

    public void setCleanupJobStatus(io.roboscale.robot.v1alpha1.workspacemanagerstatus.CleanupJobStatus cleanupJobStatus) {
    ...
    public io.roboscale.robot.v1alpha1.workspacemanagerstatus.ClonerJobStatus getClonerJobStatus() {
        return clonerJobStatus;
    }

    public void setClonerJobStatus(io.roboscale.robot.v1alpha1.workspacemanagerstatus.ClonerJobStatus clonerJobStatus) {
