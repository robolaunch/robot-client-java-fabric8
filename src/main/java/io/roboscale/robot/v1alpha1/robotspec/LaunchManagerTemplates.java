...
public class LaunchManagerTemplates implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.Map<java.lang.String, io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.Launches> launches;

    public java.util.Map<java.lang.String, io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.Launches> getLaunches() {
        return launches;
    }

    public void setLaunches(java.util.Map<java.lang.String, io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.Launches> launches) {
