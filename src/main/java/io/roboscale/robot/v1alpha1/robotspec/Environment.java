...
public class Environment implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.roboscale.robot.v1alpha1.robotspec.environment.Application application;

    public io.roboscale.robot.v1alpha1.robotspec.environment.Application getApplication() {
        return application;
    }

    public void setApplication(io.roboscale.robot.v1alpha1.robotspec.environment.Application application) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.robotspec.environment.Devspace devspace;

    public io.roboscale.robot.v1alpha1.robotspec.environment.Devspace getDevspace() {
        return devspace;
    }

    public void setDevspace(io.roboscale.robot.v1alpha1.robotspec.environment.Devspace devspace) {
