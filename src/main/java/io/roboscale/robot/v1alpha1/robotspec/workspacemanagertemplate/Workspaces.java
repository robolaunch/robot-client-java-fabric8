package io.roboscale.robot.v1alpha1.robotspec.workspacemanagertemplate;
...
public class Workspaces implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, io.roboscale.robot.v1alpha1.robotspec.workspacemanagertemplate.workspaces.Repositories> repositories;

    public java.util.Map<java.lang.String, io.roboscale.robot.v1alpha1.robotspec.workspacemanagertemplate.workspaces.Repositories> getRepositories() {
        return repositories;
    }

    public void setRepositories(java.util.Map<java.lang.String, io.roboscale.robot.v1alpha1.robotspec.workspacemanagertemplate.workspaces.Repositories> repositories) {
