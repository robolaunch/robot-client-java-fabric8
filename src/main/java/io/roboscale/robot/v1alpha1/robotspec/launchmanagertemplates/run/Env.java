...
public class Env implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.run.env.ValueFrom valueFrom;

    public io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.run.env.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.run.env.ValueFrom valueFrom) {
