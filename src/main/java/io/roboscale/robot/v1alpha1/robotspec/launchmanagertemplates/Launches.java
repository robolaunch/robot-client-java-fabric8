...
public class Launches implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launches.Container container;

    public io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launches.Container getContainer() {
        return container;
    }

    public void setContainer(io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launches.Container container) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launches.Entrypoint entrypoint;

    public io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launches.Entrypoint getEntrypoint() {
        return entrypoint;
    }

    public void setEntrypoint(io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launches.Entrypoint entrypoint) {
