...
public class Launch implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launch.Container container;

    public io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launch.Container getContainer() {
        return container;
    }

    public void setContainer(io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launch.Container container) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launch.Entrypoint entrypoint;

    public io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launch.Entrypoint getEntrypoint() {
        return entrypoint;
    }

    public void setEntrypoint(io.roboscale.robot.v1alpha1.robotspec.launchmanagertemplates.launch.Entrypoint entrypoint) {
