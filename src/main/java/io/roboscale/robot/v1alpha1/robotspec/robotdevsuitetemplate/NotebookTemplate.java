...
public class NotebookTemplate implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("[*alpha*] Notebook will create an Ingress resource if `true`.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Resource limitations of Notebook.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.robotspec.robotdevsuitetemplate.notebooktemplate.Resources resources;

    public io.roboscale.robot.v1alpha1.robotspec.robotdevsuitetemplate.notebooktemplate.Resources getResources() {
        return resources;
    }

    public void setResources(io.roboscale.robot.v1alpha1.robotspec.robotdevsuitetemplate.notebooktemplate.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Service type of Notebook. `ClusterIP` and `NodePort` is supported.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
