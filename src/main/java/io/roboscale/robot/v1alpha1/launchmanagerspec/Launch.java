...
public class Launch implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.roboscale.robot.v1alpha1.launchmanagerspec.launch.Env> env;

    public java.util.List<io.roboscale.robot.v1alpha1.launchmanagerspec.launch.Env> getEnv() {
        return env;
    }

    public void setEnv(java.util.List<io.roboscale.robot.v1alpha1.launchmanagerspec.launch.Env> env) {
        this.env = env;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.launchmanagerspec.launch.Prelaunch prelaunch;

    public io.roboscale.robot.v1alpha1.launchmanagerspec.launch.Prelaunch getPrelaunch() {
        return prelaunch;
    }

    public void setPrelaunch(io.roboscale.robot.v1alpha1.launchmanagerspec.launch.Prelaunch prelaunch) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.launchmanagerspec.launch.Resources resources;

    public io.roboscale.robot.v1alpha1.launchmanagerspec.launch.Resources getResources() {
        return resources;
    }

    public void setResources(io.roboscale.robot.v1alpha1.launchmanagerspec.launch.Resources resources) {
