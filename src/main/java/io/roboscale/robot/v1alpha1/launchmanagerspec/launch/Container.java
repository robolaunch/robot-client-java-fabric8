package io.roboscale.robot.v1alpha1.launchmanagerspec.launch;
...
public class Container implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.roboscale.robot.v1alpha1.launchmanagerspec.launch.container.Env> env;

    public java.util.List<io.roboscale.robot.v1alpha1.launchmanagerspec.launch.container.Env> getEnv() {
        return env;
    }

    public void setEnv(java.util.List<io.roboscale.robot.v1alpha1.launchmanagerspec.launch.container.Env> env) {
        this.env = env;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.launchmanagerspec.launch.container.Resources resources;

    public io.roboscale.robot.v1alpha1.launchmanagerspec.launch.container.Resources getResources() {
        return resources;
    }

    public void setResources(io.roboscale.robot.v1alpha1.launchmanagerspec.launch.container.Resources resources) {
