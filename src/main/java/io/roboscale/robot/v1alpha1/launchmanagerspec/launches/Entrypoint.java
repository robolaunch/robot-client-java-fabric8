...
public class Entrypoint implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.robot.v1alpha1.launchmanagerspec.launches.entrypoint.Prelaunch prelaunch;

    public io.roboscale.robot.v1alpha1.launchmanagerspec.launches.entrypoint.Prelaunch getPrelaunch() {
        return prelaunch;
    }

    public void setPrelaunch(io.roboscale.robot.v1alpha1.launchmanagerspec.launches.entrypoint.Prelaunch prelaunch) {
