...
public class DevSpaceVDIStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.dev.v1alpha1.devspacestatus.attacheddevobjects.status.devspacevdistatus.Resource resource;

    public io.roboscale.dev.v1alpha1.devspacestatus.attacheddevobjects.status.devspacevdistatus.Resource getResource() {
        return resource;
    }

    public void setResource(io.roboscale.dev.v1alpha1.devspacestatus.attacheddevobjects.status.devspacevdistatus.Resource resource) {
