package io.roboscale.dev.v1alpha1.devspacestatus.attacheddevobjects;
...
public class Status implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.dev.v1alpha1.devspacestatus.attacheddevobjects.status.DevSpaceIDEStatus devSpaceIDEStatus;

    public io.roboscale.dev.v1alpha1.devspacestatus.attacheddevobjects.status.DevSpaceIDEStatus getDevSpaceIDEStatus() {
        return devSpaceIDEStatus;
    }

    public void setDevSpaceIDEStatus(io.roboscale.dev.v1alpha1.devspacestatus.attacheddevobjects.status.DevSpaceIDEStatus devSpaceIDEStatus) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.dev.v1alpha1.devspacestatus.attacheddevobjects.status.DevSpaceVDIStatus devSpaceVDIStatus;

    public io.roboscale.dev.v1alpha1.devspacestatus.attacheddevobjects.status.DevSpaceVDIStatus getDevSpaceVDIStatus() {
        return devSpaceVDIStatus;
    }

    public void setDevSpaceVDIStatus(io.roboscale.dev.v1alpha1.devspacestatus.attacheddevobjects.status.DevSpaceVDIStatus devSpaceVDIStatus) {
