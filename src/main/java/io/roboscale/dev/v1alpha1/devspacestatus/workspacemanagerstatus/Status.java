...
public class Status implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.roboscale.dev.v1alpha1.devspacestatus.workspacemanagerstatus.status.CleanupJobStatus cleanupJobStatus;

    public io.roboscale.dev.v1alpha1.devspacestatus.workspacemanagerstatus.status.CleanupJobStatus getCleanupJobStatus() {
        return cleanupJobStatus;
    }

    public void setCleanupJobStatus(io.roboscale.dev.v1alpha1.devspacestatus.workspacemanagerstatus.status.CleanupJobStatus cleanupJobStatus) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.dev.v1alpha1.devspacestatus.workspacemanagerstatus.status.ClonerJobStatus clonerJobStatus;

    public io.roboscale.dev.v1alpha1.devspacestatus.workspacemanagerstatus.status.ClonerJobStatus getClonerJobStatus() {
        return clonerJobStatus;
    }

    public void setClonerJobStatus(io.roboscale.dev.v1alpha1.devspacestatus.workspacemanagerstatus.status.ClonerJobStatus clonerJobStatus) {
