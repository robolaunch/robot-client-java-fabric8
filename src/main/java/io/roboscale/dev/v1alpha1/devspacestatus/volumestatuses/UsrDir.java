...
public class UsrDir implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.dev.v1alpha1.devspacestatus.volumestatuses.usrdir.Reference reference;

    public io.roboscale.dev.v1alpha1.devspacestatus.volumestatuses.usrdir.Reference getReference() {
        return reference;
    }

    public void setReference(io.roboscale.dev.v1alpha1.devspacestatus.volumestatuses.usrdir.Reference reference) {
