...
public class WorkspaceManagerStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.roboscale.dev.v1alpha1.workspacemanagerstatus.CleanupJobStatus cleanupJobStatus;

    public io.roboscale.dev.v1alpha1.workspacemanagerstatus.CleanupJobStatus getCleanupJobStatus() {
        return cleanupJobStatus;
    }

    public void setCleanupJobStatus(io.roboscale.dev.v1alpha1.workspacemanagerstatus.CleanupJobStatus cleanupJobStatus) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.dev.v1alpha1.workspacemanagerstatus.ClonerJobStatus clonerJobStatus;

    public io.roboscale.dev.v1alpha1.workspacemanagerstatus.ClonerJobStatus getClonerJobStatus() {
        return clonerJobStatus;
    }

    public void setClonerJobStatus(io.roboscale.dev.v1alpha1.workspacemanagerstatus.ClonerJobStatus clonerJobStatus) {
