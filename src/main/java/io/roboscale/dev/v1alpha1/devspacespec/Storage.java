...
public class Storage implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Storage class selection for devspace's volumes.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.dev.v1alpha1.devspacespec.storage.StorageClassConfig storageClassConfig;

    public io.roboscale.dev.v1alpha1.devspacespec.storage.StorageClassConfig getStorageClassConfig() {
        return storageClassConfig;
    }

    public void setStorageClassConfig(io.roboscale.dev.v1alpha1.devspacespec.storage.StorageClassConfig storageClassConfig) {
