...
public class WorkspaceManagerTemplate implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    /**
     * Workspace definitions of devspace. Multiple ROS 2 workspaces can be configured over this field.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("workspaces")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Workspace definitions of devspace. Multiple ROS 2 workspaces can be configured over this field.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.roboscale.dev.v1alpha1.devspacespec.workspacemanagertemplate.Workspaces> workspaces;

    public java.util.List<io.roboscale.dev.v1alpha1.devspacespec.workspacemanagertemplate.Workspaces> getWorkspaces() {
        return workspaces;
    }

    public void setWorkspaces(java.util.List<io.roboscale.dev.v1alpha1.devspacespec.workspacemanagertemplate.Workspaces> workspaces) {
