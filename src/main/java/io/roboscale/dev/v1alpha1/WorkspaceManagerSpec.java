...
public class WorkspaceManagerSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.roboscale.dev.v1alpha1.workspacemanagerspec.Workspaces> workspaces;

    public java.util.List<io.roboscale.dev.v1alpha1.workspacemanagerspec.Workspaces> getWorkspaces() {
        return workspaces;
    }

    public void setWorkspaces(java.util.List<io.roboscale.dev.v1alpha1.workspacemanagerspec.Workspaces> workspaces) {
