package io.roboscale.fleet.v1alpha1.fleetstatus.namespacestatus;
...
public class Resource implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.fleet.v1alpha1.fleetstatus.namespacestatus.resource.Reference reference;

    public io.roboscale.fleet.v1alpha1.fleetstatus.namespacestatus.resource.Reference getReference() {
        return reference;
    }

    public void setReference(io.roboscale.fleet.v1alpha1.fleetstatus.namespacestatus.resource.Reference reference) {
