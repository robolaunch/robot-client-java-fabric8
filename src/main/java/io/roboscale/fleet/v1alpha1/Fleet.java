...
public class Fleet extends io.fabric8.kubernetes.client.CustomResource<io.roboscale.fleet.v1alpha1.FleetSpec, io.roboscale.fleet.v1alpha1.FleetStatus> implements io.fabric8.kubernetes.api.model.Namespaced {
}
