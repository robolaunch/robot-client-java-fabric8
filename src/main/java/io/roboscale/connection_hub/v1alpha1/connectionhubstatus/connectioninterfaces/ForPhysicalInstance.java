...
public class ForPhysicalInstance implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.roboscale.connection_hub.v1alpha1.connectionhubstatus.connectioninterfaces.forphysicalinstance.FederationSpec federationSpec;

    public io.roboscale.connection_hub.v1alpha1.connectionhubstatus.connectioninterfaces.forphysicalinstance.FederationSpec getFederationSpec() {
        return federationSpec;
    }

    public void setFederationSpec(io.roboscale.connection_hub.v1alpha1.connectionhubstatus.connectioninterfaces.forphysicalinstance.FederationSpec federationSpec) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.connection_hub.v1alpha1.connectionhubstatus.connectioninterfaces.forphysicalinstance.SubmarinerSpec submarinerSpec;

    public io.roboscale.connection_hub.v1alpha1.connectionhubstatus.connectioninterfaces.forphysicalinstance.SubmarinerSpec getSubmarinerSpec() {
        return submarinerSpec;
    }

    public void setSubmarinerSpec(io.roboscale.connection_hub.v1alpha1.connectionhubstatus.connectioninterfaces.forphysicalinstance.SubmarinerSpec submarinerSpec) {
