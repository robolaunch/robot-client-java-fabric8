...
public class SubmarinerSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @io.fabric8.generator.annotation.Required()
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.connection_hub.v1alpha1.connectionhubspec.submarinerspec.GatewayImage gatewayImage;

    public io.roboscale.connection_hub.v1alpha1.connectionhubspec.submarinerspec.GatewayImage getGatewayImage() {
        return gatewayImage;
    }

    public void setGatewayImage(io.roboscale.connection_hub.v1alpha1.connectionhubspec.submarinerspec.GatewayImage gatewayImage) {
    ...
    @io.fabric8.generator.annotation.Required()
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.connection_hub.v1alpha1.connectionhubspec.submarinerspec.OperatorImage operatorImage;

    public io.roboscale.connection_hub.v1alpha1.connectionhubspec.submarinerspec.OperatorImage getOperatorImage() {
        return operatorImage;
    }

    public void setOperatorImage(io.roboscale.connection_hub.v1alpha1.connectionhubspec.submarinerspec.OperatorImage operatorImage) {
    ...
    @io.fabric8.generator.annotation.Required()
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.roboscale.connection_hub.v1alpha1.connectionhubspec.submarinerspec.SubmarinerImages submarinerImages;

    public io.roboscale.connection_hub.v1alpha1.connectionhubspec.submarinerspec.SubmarinerImages getSubmarinerImages() {
        return submarinerImages;
    }

    public void setSubmarinerImages(io.roboscale.connection_hub.v1alpha1.connectionhubspec.submarinerspec.SubmarinerImages submarinerImages) {
